...
setTimeout(function(){a.element&&a._trigger("complete")},0)})});a.__init();a.refreshDataAndView({header:!0})}},a;b.__init=function(){a||(a=l("").appendTo(document.body))};l.widget("paramquery.pqGrid",d._pqGrid,b);l.widget.extend=function(){var a=Array.prototype.shift,
